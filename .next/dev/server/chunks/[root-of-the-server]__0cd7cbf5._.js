...
async function GET() {
    try {
        ...
        // 1. Fetch Counts
        const totalClients = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].user.count({
            where: {
                role: 'client'
            }
        });
        const totalNutritionists = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].nutritionist.count();
        const pendingVerifications = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].nutritionist.count({
            where: {
                verification_status: 'submitted'
            }
        });
        // 2. Calculate Revenue (Sum of all completed appointments)
        const earnings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointment.aggregate({
            where: {
                status: 'completed'
            },
            _sum: {
        ...
        const recentBookings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].appointment.findMany({
            take: 5,
            orderBy: {
                created_at: 'desc'
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0cd7cbf5._.js.map