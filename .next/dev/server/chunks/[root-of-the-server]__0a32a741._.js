...
"[project]/app/api/client/appointments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const appointments = await sql(`SELECT a.*, u.full_name as nutritionist_name, u.avatar_url
       FROM appointments a
...
async function POST(request) {
    try {
        ...
        const sql = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSql"])();
        const result = await sql(`INSERT INTO appointments (client_id, nutritionist_id, scheduled_at, duration_minutes, notes, price, status)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0a32a741._.js.map