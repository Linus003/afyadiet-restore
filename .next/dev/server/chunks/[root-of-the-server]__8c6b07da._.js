...
async function GET() {
    try {
        ...
        const pending = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].nutritionist.findMany({
            where: {
...
async function POST(request) {
    try {
        ...
        if (action === 'approve') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].nutritionist.update({
                where: {
                    id: nutritionistId
                },
                data: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8c6b07da._.js.map